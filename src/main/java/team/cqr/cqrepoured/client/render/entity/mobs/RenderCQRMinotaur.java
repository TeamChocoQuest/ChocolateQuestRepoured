...
public class RenderCQRMinotaur extends RenderCQRBipedBaseGeo<EntityCQRMinotaur> {
	...
	@Override
	protected void preRenderBlock(PoseStack stack, BlockState block, String boneName, EntityCQRMinotaur currentEntity) {
		
	}

	@Override
	protected void postRenderBlock(PoseStack stack, BlockState block, String boneName, EntityCQRMinotaur currentEntity) {
		
	}

	@Override
	protected void postRenderItem(PoseStack matrixStack, ItemStack item, String boneName, EntityCQRMinotaur currentEntity, IBone bone) {
