...
public enum EDefaultFaction {
	...
	WALKERS(new String[] {
			...
			"ILLAGERS",
			"VILLAGERS",
			"NPC" }, new String[] {}, EReputationState.ARCH_ENEMY, false),
	DWARVES_AND_GOLEMS(new String[] { "WALKERS", "ENDERMEN", "ILLAGERS", "UNDEAD" }, new String[] { "VILLAGERS", "NPC", "INQUISITION" },
			EReputationState.ACCEPTED),
	GOBLINS(new String[] { "OGRES_AND_GREMLINS", "WALKERS", "INQUISITION" }, new String[] { "TRITONS", "VILLAGERS" }, EReputationState.ACCEPTED),
	ENDERMEN(new String[] { "WALKERS", "PLAYERS", "DWARVES_AND_GOLEMS", "VILLAGERS", "NPCS", "PIRATE", "TRITONS" }, new String[] { "ILLAGERS", "UNDEAD" },
			EReputationState.ENEMY),
	// OGRES_AND_GREMLINS(new String[] {}, new String[] {}, EReputationState.NEUTRAL),
	INQUISITION(new String[] { "WALKERS", "ILLAGERS", "UNDEAD", "GOBLINS" }, new String[] { "DWARVES_AND_GOLEMS", "NPC", "VILLAGERS" },
			EReputationState.NEUTRAL),
	...
	ALL_ALLY(new String[] {},
			new String[] {
					...
					"TRITONS",
					"PLAYERS" },
			EReputationState.NEUTRAL, false),
	...
	ILLAGERS(new String[] { "TRITONS", "VILLAGERS", "DWARVES_AND_GOLEMS", "UNDEAD" }, new String[] { "GREMLINS, PIRATE, ENDERMEN" }, EReputationState.ENEMY,
			false),
	GREMLINS(new String[] { "DWARVES_AND_GOLEMS", "GOBLINS", "UNDEAD", "WALKERS", "BEASTS", "ENDERMEN" }, new String[] { "ILLAGERS", "PIRATE" },
			EReputationState.ENEMY, false),;
