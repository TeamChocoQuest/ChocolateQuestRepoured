...
public class ItemArmorDyable extends ItemArmor {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
		if (this.getArmorMaterial() == ArmorMaterial.IRON) {
			return Reference.MODID + ":textures/models/armor/iron_dyable_layer_" + (slot != EntityEquipmentSlot.LEGS ? 1 : 2) + (type != null ? "_" + type : "")
					+ ".png";
		}
		if (this.getArmorMaterial() == ArmorMaterial.DIAMOND) {
			return Reference.MODID + ":textures/models/armor/diamond_dyable_layer_" + (slot != EntityEquipmentSlot.LEGS ? 1 : 2)
