...
public class BossAIPirateTeleportBehindEnemy extends AbstractCQREntityAI<EntityCQRPirateCaptain> {
	...
	public boolean shouldExecute() {
		...
		return this.cooldown <= 0
				...
				&& this.entity.getDistance(this.entity.getAttackTarget()) >= MIN_ATTACK_DISTANCE
				&& (!this.entity.isInvisible() && !this.entity.isReintegrating() && !this.entity.isDisintegrating());
	}
