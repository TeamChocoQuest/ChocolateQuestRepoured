...
import com.tiviacz.chocolatequestrepoured.objects.items.ItemGoldenFeather;
import com.tiviacz.chocolatequestrepoured.objects.items.ItemPotionHealing;
import com.tiviacz.chocolatequestrepoured.objects.items.ItemShieldWalker;
import com.tiviacz.chocolatequestrepoured.objects.items.ItemStaffFire;
import com.tiviacz.chocolatequestrepoured.objects.items.ItemTeleportStone;
import com.tiviacz.chocolatequestrepoured.objects.items.guns.ItemBullet;
import com.tiviacz.chocolatequestrepoured.objects.items.guns.ItemMusket;
import com.tiviacz.chocolatequestrepoured.objects.items.guns.ItemMusketKnife;
import com.tiviacz.chocolatequestrepoured.objects.items.guns.ItemRevolver;
import com.tiviacz.chocolatequestrepoured.objects.items.swords.ItemDaggerBase;
import com.tiviacz.chocolatequestrepoured.objects.items.swords.ItemDaggerNinja;
import com.tiviacz.chocolatequestrepoured.objects.items.swords.ItemGreatSwordBase;
import com.tiviacz.chocolatequestrepoured.objects.items.swords.ItemSwordSpider;
import com.tiviacz.chocolatequestrepoured.objects.items.swords.ItemSwordTurtle;
import com.tiviacz.chocolatequestrepoured.objects.items.swords.ItemSwordWalker;
...
public class ModItems 
{
	...
	public static final ArmorMaterial ARMOR_HEAVY_IRON = EnumHelper.addArmorMaterial("armor_heavy_iron", Reference.MODID + ":heavy_iron", 1975, new int[] { 4, 7, 9, 4 }, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1.0F);
