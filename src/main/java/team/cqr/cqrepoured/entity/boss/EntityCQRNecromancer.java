...
public class EntityCQRNecromancer extends AbstractEntityCQRMageBase implements ISummoner {
	...
	protected void initEntityAI() {
		super.initEntityAI();
		this.spellHandler.addSpell(0, new EntityAISummonMinionSpell(this, 200, 50, new ResourceLocation(CQRMain.MODID, "skeleton"), ECircleTexture.SKELETON, true, 9, 3, new Vec3d(0, 0, 0)) {
			@Override
			public boolean isInterruptible() {
				return false;
			}
		});
		this.spellHandler.addSpell(1, new EntityAISummonMinionSpell(this, 100, 30, new ResourceLocation(CQRMain.MODID, "flying_skull"), ECircleTexture.FLYING_SKULL, false, 6, 2, new Vec3d(0, 2.5, 0)) {
			@Override
			public boolean isInterruptible() {
				return false;
			}
