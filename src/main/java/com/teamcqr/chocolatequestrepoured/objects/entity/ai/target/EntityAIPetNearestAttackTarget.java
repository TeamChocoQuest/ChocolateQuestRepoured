            ...
            this.targetEntity = (T)this.taskOwner.world.getNearestAttackablePlayer(this.taskOwner.posX, this.taskOwner.posY + (double)this.taskOwner.getEyeHeight(), this.taskOwner.posZ, this.getTargetDistance(), this.getTargetDistance(), new Function<EntityPlayer, Double>()
            {
                ...
                public Double apply(@Nullable EntityPlayer p_apply_1_)
                {
                    ...
                    if (itemstack.getItem() == Items.SKULL)
                    {
                        ...
                        boolean flag = EntityAIPetNearestAttackTarget.this.taskOwner instanceof EntitySkeleton && i == 0;
                        boolean flag1 = EntityAIPetNearestAttackTarget.this.taskOwner instanceof EntityZombie && i == 2;
                        boolean flag2 = EntityAIPetNearestAttackTarget.this.taskOwner instanceof EntityCreeper && i == 4;
