...
public class RenderCQREnderman extends RenderCQRBipedBaseGeo<EntityCQREnderman> {
	...
	@Override
	protected ResourceLocation getTextureForBone(String boneName, EntityCQREnderman currentEntity) {
		return null;
	}
	...
	@Override
	protected void preRenderBlock(BlockState block, String boneName, EntityCQREnderman currentEntity) {
	...
	@Override
	protected void postRenderBlock(BlockState block, String boneName, EntityCQREnderman currentEntity) {
