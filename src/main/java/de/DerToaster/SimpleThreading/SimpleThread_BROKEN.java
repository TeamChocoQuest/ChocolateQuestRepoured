...
class SimpleThread_BROKEN extends Thread {
	...
	public void addTask(Runnable task) {
		...
		/*
		 * boolean runAfterAdd = false; if(this.tasks.isEmpty()) { runAfterAdd = true; }
		 */
	...
	public void run() {
		if (!this.tasks.isEmpty()) {
			...
			/*
			 * this.rerunsTillStop--; if(this.rerunsTillStop <= 0) { this.running = false; this.rerunsTillStop = 20; } else {
			 */
