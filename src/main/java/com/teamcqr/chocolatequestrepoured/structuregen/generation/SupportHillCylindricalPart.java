...
public class SupportHillCylindricalPart implements IStructure {
	...
	public SupportHillCylindricalPart(NBTTagCompound compound) {
		this.readFromNBT(compound);
	}

	public SupportHillCylindricalPart(BlockPos startPos, int cX, int cZ, int sizeX, int sizeZ, int partStartX, int partStartZ, int partSizeX, int partSizeZ, int platformRadius, int wallSize, Block structureBlock, Block structureTopBlock) {
	...
	public NBTTagCompound writeToNBT() {
		...
		compound.setString("id", "supportHillCylindricalPart");
		...
		compound.setInteger("centerX", this.centerX);
		compound.setInteger("centerZ", this.centerZ);
		compound.setInteger("platformRadius", this.platformRadius);
	...
	public void readFromNBT(NBTTagCompound compound) {
		...
		this.centerX = compound.getInteger("centerX");
		this.centerZ = compound.getInteger("centerZ");
		this.platformRadius = compound.getInteger("platformRadius");
