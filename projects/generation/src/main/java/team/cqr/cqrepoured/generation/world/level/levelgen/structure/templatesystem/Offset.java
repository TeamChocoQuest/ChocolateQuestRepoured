...
public enum Offset {
	...
	NORTH_EAST {
		@Override
		public BlockPos apply(BlockPos pos, CQRStructureTemplate structure, Mirror mirror, Rotation rotation) {
			/*
			 * 0 -> 0 0
			 * 90 -> 0 1
			 * 180 -> 1 1
	...
	public abstract BlockPos apply(BlockPos pos, CQRStructureTemplate structure, Mirror mirror, Rotation rotation);
