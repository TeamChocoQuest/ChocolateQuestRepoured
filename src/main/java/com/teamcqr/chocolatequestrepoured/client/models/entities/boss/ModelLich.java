...
public class ModelLich extends ModelBase {
    ...
    public ModelLich() {
        ...
        this.Head = new ModelRenderer(this, 51, 0);
        ...
        this.Arm_Right.addBox(-4.0F, 0.0F, -2.0F, 4, 8, 4, 0.0F);
        ...
        this.Arm_Right_Bone.setRotationPoint(-2.0F, 8.0F, 0.0F);
        ...
        this.Arm_Left.addBox(-0.0F, 0.0F, -2.0F, 4, 8, 4, 0.0F);
