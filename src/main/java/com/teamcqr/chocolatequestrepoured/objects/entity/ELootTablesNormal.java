...
public enum ELootTablesNormal {
	...
	ENTITY_OGRE("ogre"),
	ENTITY_ORC("orc"),
	ENTITY_PIRATE("pirate"),
	ENTITY_SKELETON("skeleton"),
	ENTITY_SPECTRE("spectre"),
	ENTITY_TRITON("triton"),
	ENTITY_WALKER("walker"),
	ENTITY_ZOMBIE("zombie"),
	ENTITY_ZOMBIE_TRITON("zombie_triton"),

	// "Ambient" mobs and mounts
	ENTITY_BEE("mounts/bee"),
	ENTITY_GIANT_ENDERMITE("mounts/endermite"),
