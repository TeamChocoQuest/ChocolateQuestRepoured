...
public class ModelHook extends ModelBase {
    ...
    public ModelHook() {
        ...
        this.setRotateAngle(clawRight, 0.0F, 0.7853981633974483F, 0.0F);
        ...
        this.setRotateAngle(clawLeft, 0.0F, -0.7853981633974483F, 0.0F);
        ...
        this.setRotateAngle(clawUp, -0.7853981633974483F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(clawDown, 0.7853981633974483F, 0.0F, 0.0F);
