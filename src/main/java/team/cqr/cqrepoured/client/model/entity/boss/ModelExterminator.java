...
public class ModelExterminator extends AnimatedGeoModel<EntityCQRExterminator> {
	...
	static final ResourceLocation MODEL_RESLOC = new ResourceLocation(CQRMain.MODID, "geo/exterminator.geo.json");
	...
	public ResourceLocation getTextureLocation(EntityCQRExterminator entity) {
		...
		// Custom texture end
		return entity.getTextureCount() > 1 ? new ResourceLocation(CQRMain.MODID, "textures/entity/boss/exterminator_" + entity.getTextureIndex() + ".png")
				: this.texture;
	}
