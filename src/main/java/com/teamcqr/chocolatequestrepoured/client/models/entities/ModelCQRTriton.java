...
public class ModelCQRTriton extends ModelCQRBiped {
	...
	public ModelCQRTriton(float modelSize, float p_i1149_2_, int textureWidthIn, int textureHeightIn) {
        ...
        this.setRotateAngle(mouthTentacle1, -0.6981317007977318F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(mouthTentacle3, -0.6981317007977318F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(mouthTentacle2, -0.6981317007977318F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(mouthTentacle4, -0.6981317007977318F, 0.0F, 0.0F);
