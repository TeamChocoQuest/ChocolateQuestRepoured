...
public class EntityAITameAndLeashPet extends AbstractCQREntityAI<AbstractEntityCQR> {
	...
	public boolean shouldExecute() {
		...
		if (this.random.nextInt(10) == 0) {
			...
			List<EntityTameable> possiblePets = this.entity.world.getEntitiesWithinAABB(EntityTameable.class, aabb,
					input -> TargetUtil.PREDICATE_PETS.apply(input) && this.entity.getEntitySenses().canSee(input));
