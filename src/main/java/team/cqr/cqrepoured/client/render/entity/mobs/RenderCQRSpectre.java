...
public class RenderCQRSpectre extends RenderCQRBipedBaseGeo<EntityCQRSpectre> {
	...
	@Override
	protected void postRenderBlock(BlockState block, String boneName, EntityCQRSpectre currentEntity) {
		
	}

	@Override
	protected ResourceLocation getTextureForBone(String boneName, EntityCQRSpectre currentEntity) {
		return null;
	}
