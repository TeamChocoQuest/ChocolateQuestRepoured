...
public class CQOgreEntity extends AbstractEntityCQR {

    public CQOgreEntity(EntityType<? extends AbstractEntityCQR> type, Level level) {
        super(type, level);
    }
    ...
    public EDefaultFaction getDefaultFaction() {
        return EDefaultFaction.OGRES_AND_GREMLINS;
    }
