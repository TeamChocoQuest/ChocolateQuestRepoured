package com.teamcqr.chocolatequestrepoured.client.render.weather;
...
public class RenderWeatherWalkerLightningBolt extends RenderLightningBolt {

	private static final float RED = 0.33595F;
	private static final float GREEN = 0.08395F;
	private static final float BLUE = 0.43165F;
	private static final float ALPHA = 0.4F;
	
	public RenderWeatherWalkerLightningBolt(RenderManager renderManagerIn) {
