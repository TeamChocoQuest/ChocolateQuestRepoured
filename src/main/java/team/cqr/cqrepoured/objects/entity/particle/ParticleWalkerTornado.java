package team.cqr.cqrepoured.objects.entity.particle;

import net.minecraft.world.World;

public class ParticleWalkerTornado extends EntityParticle {

	public ParticleWalkerTornado(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn) {
