...
public class ChannelIdle extends Channel {
	...
	protected void initializeAllFrames() {
		...
		frame0.modelRenderersRotations.put("wingL", new Quaternion(-0.055162758F, 0.11829691F, -0.4190027F, 0.8985542F));
		frame0.modelRenderersRotations.put("wingR", new Quaternion(-0.4190027F, 0.89855415F, -0.055162776F, 0.11829695F));
		...
		frame9.modelRenderersRotations.put("wingL", new Quaternion(-0.055162758F, 0.11829691F, -0.4190027F, 0.8985542F));
		frame9.modelRenderersRotations.put("wingR", new Quaternion(-0.4190027F, 0.89855415F, -0.055162776F, 0.11829695F));
