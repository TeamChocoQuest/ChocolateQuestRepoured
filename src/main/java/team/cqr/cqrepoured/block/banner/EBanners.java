...
public enum EBanners {
	...
	PIRATE_BANNER(EnumDyeColor.BLACK, new BannerPattern[] { EBannerPatternsCQ.CQ_BLANK.getPattern(), BannerPattern.SKULL },
			new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.WHITE }),
	...
	PIGMAN_BANNER(EnumDyeColor.RED, new BannerPattern[] { EBannerPatternsCQ.CQ_BLANK.getPattern(), EBannerPatternsCQ.FIRE.getPattern() },
			new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.YELLOW }),
	ENDERMAN_BANNER(EnumDyeColor.MAGENTA,
			new BannerPattern[] { EBannerPatternsCQ.CQ_BLANK.getPattern(), BannerPattern.TRIANGLE_BOTTOM, BannerPattern.TRIANGLE_TOP },
			new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.BLACK, EnumDyeColor.BLACK }),
	ENDERMAN_BANNER2(EnumDyeColor.MAGENTA,
			new BannerPattern[] { EBannerPatternsCQ.CQ_BLANK.getPattern(), BannerPattern.SQUARE_TOP_RIGHT, BannerPattern.SQUARE_BOTTOM_LEFT },
			new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.BLACK, EnumDyeColor.BLACK }),
	NPC_BANNER(EnumDyeColor.RED,
			new BannerPattern[] {
					EBannerPatternsCQ.CQ_BLANK.getPattern(),
					BannerPattern.FLOWER,
					BannerPattern.STRIPE_CENTER,
					EBannerPatternsCQ.EMERALD.getPattern() },
			new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.YELLOW, EnumDyeColor.RED, EnumDyeColor.LIME }),
	SKELETON_BANNER(EnumDyeColor.BLACK,
			new BannerPattern[] { EBannerPatternsCQ.CQ_BLANK.getPattern(), BannerPattern.CROSS, EBannerPatternsCQ.BONES.getPattern() },
			new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.RED, EnumDyeColor.WHITE }),
	...
	EBanners(EnumDyeColor mainColor, BannerPattern[] patterns, EnumDyeColor[] colors) {
