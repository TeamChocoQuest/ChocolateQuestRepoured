...
public class LayerCQRLeaderFeather<T extends AbstractEntityCQR> extends AbstractLayerCQR<T> {

	private static final ItemStack STACK = new ItemStack(Items.FEATHER);

	private ModelRenderer bipedHead;

	public LayerCQRLeaderFeather(RenderCQREntity<T> renderer, ModelRenderer bipedHead) {
		super(renderer);
