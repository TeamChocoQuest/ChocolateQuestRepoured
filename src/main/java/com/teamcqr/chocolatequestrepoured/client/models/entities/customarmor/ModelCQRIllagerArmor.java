...
public class ModelCQRIllagerArmor extends ModelBiped {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		...
		if (!ent.isAggressive() && !(ent.getHeldItemMainhand().getItem() instanceof ItemPotionHealing)) {
			/*
			 * this.arms.rotationPointY = 3.0F; this.arms.rotationPointZ = -1.0F; this.arms.rotateAngleX = -0.75F;
			 */
		...
		if (ent.isAggressive() || ent.getHeldItemMainhand().getItem() instanceof ItemPotionHealing) {
			 ...
			 * this.bipedLeftArm.rotationPointX = 5.0F; this.bipedRightArm.rotateAngleX = MathHelper.cos(ageInTicks * 0.6662F) * 0.25F; this.bipedLeftArm.rotateAngleX = MathHelper.cos(ageInTicks * 0.6662F) * 0.25F;
			 * this.bipedRightArm.rotateAngleZ = 2.3561945F; this.bipedLeftArm.rotateAngleZ = -2.3561945F; this.bipedRightArm.rotateAngleY = 0.0F; this.bipedLeftArm.rotateAngleY = 0.0F; }
			 */
