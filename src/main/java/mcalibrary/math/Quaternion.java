...
public class Quaternion implements java.io.Serializable {
	...
	/**
	 * Sets the data in this <code>Quaternion</code> object to be equal to the passed <code>Quaternion</code> object. The values are copied producing a new object.
	 *
	...
	/**
	 * Sets the value of this quaternion to the quaternion product of quaternions q1 and q2 (this = q1 * q2). Note that this is safe for aliasing (e.g. this can be q1 or q2). This operation is used for adding the 2 orientations.
	 */
	...
	/**
	 * Subtracts the values of the parameter quaternion from those of this quaternion. The result is stored in this Quaternion.
	 *
	...
	/**
	 * Returns the norm of this quaternion. This is the dot product of this quaternion with itself.
	 *
	...
	/**
	 * Normalizes the current <code>Quaternion</code>. The result is stored internally.
	 */
