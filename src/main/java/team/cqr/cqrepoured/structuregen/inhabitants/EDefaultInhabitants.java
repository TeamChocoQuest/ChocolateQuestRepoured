...
enum EDefaultInhabitants {
	...
	PIRATE(new ResourceLocation[] { new ResourceLocation(Reference.MODID, "pirate") }, new ResourceLocation[] { new ResourceLocation(Reference.MODID, "pirate_captain") }, EBanners.PIRATE_BANNER, CQRItems.SHIELD_PIRATE2),
	ILLAGER(new ResourceLocation[] { new ResourceLocation(Reference.MODID, "illager") }, null, EBanners.ILLAGER_BANNER),
	WALKER(new ResourceLocation[] { new ResourceLocation(Reference.MODID, "walker") }, new ResourceLocation[] { new ResourceLocation(Reference.MODID, "walker_king") }, EBanners.WALKER_ORDO, CQRItems.SHIELD_WALKER),
	...
	BOARMAN(new ResourceLocation[] { new ResourceLocation(Reference.MODID, "boarman") }, new ResourceLocation[] { new ResourceLocation(Reference.MODID, "boar_mage") }, EBanners.PIGMAN_BANNER, CQRItems.SHIELD_FIRE),
