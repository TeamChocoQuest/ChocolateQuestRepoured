...
public class RenderCQRNPC extends RenderCQRBipedBaseGeo<EntityCQRNPC> {
	...
	@Override
	protected void preRenderItem(ItemStack item, String boneName, EntityCQRNPC currentEntity) {
		
	}

	@Override
	protected void preRenderBlock(BlockState block, String boneName, EntityCQRNPC currentEntity) {
		
	}

	@Override
	protected void postRenderItem(ItemStack item, String boneName, EntityCQRNPC currentEntity) {
		
	}

	@Override
	protected void postRenderBlock(BlockState block, String boneName, EntityCQRNPC currentEntity) {
		
	}

	@Override
	protected ResourceLocation getTextureForBone(String boneName, EntityCQRNPC currentEntity) {
		return null;
	}
