...
enum EDefaultInhabitants {
	...
	DEFAULT(new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "dummy") }, new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "dummy") },
			null, Items.SHIELD),
	DWARF(new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "dwarf") }, null, null, CQRItems.SHIELD_CARL),
	SKELETON(new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "skeleton") },
			new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "necromancer") }, EBanners.SKELETON_BANNER, CQRItems.SHIELD_SKELETON_FRIENDS),
	ZOMBIE(new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "zombie") }, new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "lich") },
			null, CQRItems.SHIELD_ZOMBIE),
	PIRATE(new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "pirate") },
			new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "pirate_captain") }, EBanners.PIRATE_BANNER, CQRItems.SHIELD_PIRATE2),
	ILLAGER(new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "illager") }, null, EBanners.ILLAGER_BANNER),
	WALKER(new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "walker") },
			new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "walker_king") }, EBanners.WALKER_ORDO, CQRItems.SHIELD_WALKER),
	...
	BOARMAN(new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "boarman") },
			new ResourceLocation[] { new ResourceLocation(CQRMain.MODID, "boar_mage") }, EBanners.PIGMAN_BANNER, CQRItems.SHIELD_FIRE),
