...
import team.cqr.cqrepoured.client.model.geo.entity.ModelCQRSkeletonGeo;
...
public class RenderCQRSkeleton extends RenderCQRBipedBaseGeo<EntityCQRSkeleton> {
	...
	@Override
	protected void preRenderItem(ItemStack item, String boneName, EntityCQRSkeleton currentEntity) {
		
	}

	@Override
	protected void preRenderBlock(BlockState block, String boneName, EntityCQRSkeleton currentEntity) {
		
	}

	@Override
	protected void postRenderItem(ItemStack item, String boneName, EntityCQRSkeleton currentEntity) {
		
	}

	@Override
	protected void postRenderBlock(BlockState block, String boneName, EntityCQRSkeleton currentEntity) {
		
	}

	@Override
	protected ResourceLocation getTextureForBone(String boneName, EntityCQRSkeleton currentEntity) {
		return null;
	}

	@Override
	protected void preRenderItem(MatrixStack matrixStack, ItemStack item, String boneName, EntityCQRSkeleton currentEntity, IBone bone) {
