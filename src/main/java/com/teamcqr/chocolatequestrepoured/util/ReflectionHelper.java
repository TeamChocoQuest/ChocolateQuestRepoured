...
public class ReflectionHelper {
	 ...
	 *
	 * NOTE: This method intentionally uses the reflectGetAllFields utility method from this class, causing a minor performance loss when compared directly to the getField method of a class object. This is done to avoid recreating the
	 * recursive structure necessary to get all fields from superclasses using getDeclaredField(s) (the getField(s) methods don't return private fields, which defeats the entire purpose of this util). If being used in a situation where the
	 * performance penalty from this actually matters, this util should probably not be being used anyway.
	 *
