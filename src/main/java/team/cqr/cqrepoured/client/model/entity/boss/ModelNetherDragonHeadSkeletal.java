...
public class ModelNetherDragonHeadSkeletal extends ModelBase {
	...
	public ModelNetherDragonHeadSkeletal() {
		...
		this.setRotateAngle(this.ribLUpper, -1.5707963267948966F, -2.744530248761083F, 1.5707963267948966F);
		...
		this.setRotateAngle(this.ribLMiddle2, 0.0F, 0.0F, 1.1780972450961724F);
		...
		this.setRotateAngle(this.ribRUpper, 1.5707963267948966F, 2.743657584135086F, 1.5707963267948966F);
		...
		this.setRotateAngle(this.ribRUpper2, 1.5707963267948966F, 2.743657584135086F, 1.5707963267948966F);
		...
		this.setRotateAngle(this.ribRMiddle2, 0.0F, 0.0F, 1.1780972450961724F);
		...
		this.setRotateAngle(this.ribLUpper2, -1.5707963267948966F, -2.743657584135086F, 1.5707963267948966F);
		...
		this.setRotateAngle(this.ribRLower2, 0.0F, 0.0F, 1.1780972450961724F);
		...
		this.setRotateAngle(this.HeadNonSkeletal, 0.0F, 1.5707963267948966F, 0.0F);
		...
		this.setRotateAngle(this.ribLLower2, 0.0F, 0.0F, 1.1780972450961724F);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
		...
		if (dragon.isMouthOpen()) {
			float angle = (float) Math.toRadians(13);
			this.setRotateAngle(this.Mouth_Bottom, 0, 0, angle * 2);
			this.setRotateAngle(this.Mouth_Top, 0, 0, -angle);
		} else {
			this.setRotateAngle(this.Mouth_Bottom, 0, 0, 0);
			this.setRotateAngle(this.Mouth_Top, 0, 0, 0);
		}
	}
