...
/**
 * CQRWasp - DerToaster Created using Tabula 7.0.1
 */
public class ModelCQRWasp extends ModelBase {
	...
	public ModelCQRWasp(float size) {
		...
		this.setRotateAngle(this.wingR, 0.0F, -2.8797932657906435F, 0.3839724354387525F);
		...
		this.setRotateAngle(this.wingL, 0.0F, -0.2617993877991494F, -0.3839724354387525F);
		...
		this.setRotateAngle(this.sting, -0.7853981633974483F, 0.0F, 0.0F);
		...
		this.setRotateAngle(this.bodyBack, -0.40142572795869574F, 0.0F, 0.0F);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		float angle = -22.5F;
		angle += 45F * ((float) (1D + Math.sin(((2D * Math.PI) / 8) * entity.ticksExisted)));
