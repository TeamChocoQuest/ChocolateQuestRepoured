package team.cqr.cqrepoured.client.render.entity.layers.geckolib;
...
public class LayerElectrocuteGecko<T extends EntityLivingBase & IAnimatable> extends GeoLayerRenderer<T> {

	public LayerElectrocuteGecko(IGeoRenderer<T> entityRendererIn) {
