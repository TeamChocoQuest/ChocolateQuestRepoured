 ...
 * @author Silentine
 */
public class ModelArmorBull<T extends LivingEntity> extends ModelCustomArmorBase<T> {
	...
	public ModelArmorBull(float scale) {
		...
		this.hornR2.setPos(0.0F, -3.0F, 0.6F);
		...
		this.hornR3.setPos(0.0F, -0.5F, -0.2F);
		...
		this.hornL1.setPos(4.5F, -8.5F, -4.5F);
		...
		this.hornL2.setPos(0.0F, -3.0F, 0.6F);
		...
		this.hornL3.setPos(0.0F, -0.5F, -0.2F);
		...
		this.pauldronR1.setPos(-3.3F, 0.5F, 0.0F);
		...
		this.shoulderHornR2.setPos(-0.2F, -1.0F, 0.0F);
		...
		this.shoulderHornR3.setPos(-0.1F, -2.8F, 0.1F);
		...
		this.pauldronL1.setPos(3.3F, 0.5F, 0.0F);
		...
		this.pauldronL2.setPos(-0.5F, -1.5F, 0.0F);
		...
		this.shoulderHornL1.setPos(-0.8F, -1.6F, 0.0F);
		...
		this.shoulderHornL2.setPos(0.2F, -1.0F, 0.0F);
		...
		this.shoulderHornL3.setPos(0.1F, -2.8F, 0.1F);
