...
public class BackpackContainer extends Container {
	...
	public BackpackContainer(int containerID, PlayerInventory playerInv, PacketBuffer data)
	{
		this(containerID, playerInv, playerInv.player.getMainHandItem());
	}

	public BackpackContainer(int containerID, PlayerInventory playerInv, ItemStack stack)
	{
