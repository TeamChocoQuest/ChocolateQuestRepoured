...
public enum EDungeonMobType {
	...
	// DONT_REPLACE(null),
	DWARF(new ResourceLocation(Reference.MODID, "dwarf"), null, null), SKELETON(new ResourceLocation(Reference.MODID, "skeleton"), new ResourceLocation(Reference.MODID, "necromancer"), EBanners.SKELETON_BANNER),
	ZOMBIE(new ResourceLocation(Reference.MODID, "zombie"), new ResourceLocation(Reference.MODID, "lich"), null), PIRATE(new ResourceLocation(Reference.MODID, "pirate"), null, EBanners.PIRATE_BANNER),
	ILLAGER(new ResourceLocation(Reference.MODID, "illager"), null, EBanners.ILLAGER_BANNER), WALKER(new ResourceLocation(Reference.MODID, "walker"), null, EBanners.WALKER_ORDO),
	SPECTER(new ResourceLocation(Reference.MODID, "spectre"), null, null), ENDERMAN(new ResourceLocation(Reference.MODID, "enderman"), null, EBanners.ENDERMEN_BANNER),
	BOARMAN(new ResourceLocation(Reference.MODID, "boarman"), new ResourceLocation(Reference.MODID, "boar_mage"), EBanners.PIGMAN_BANNER), MINOTAUR(new ResourceLocation(Reference.MODID, "minotaur"), null, null),
	ORC(new ResourceLocation(Reference.MODID, "orc"), null, null), GOLEM(new ResourceLocation(Reference.MODID, "golem"), null, null), GOBLIN(new ResourceLocation(Reference.MODID, "goblin"), null, null),
	MUMMY(new ResourceLocation(Reference.MODID, "mummy"), null, null), OGRE(new ResourceLocation(Reference.MODID, "ogre"), null, null), TRITON(new ResourceLocation(Reference.MODID, "triton"), null, null);
	...
	public static EDungeonMobType getMobTypeDependingOnDistance(int x, int z) {
		 ...
		 * 
		 * Skeleton Zombie Illager Goblin/Orc/Ogre -> Random Specter Minotaur? Endermen
		 * 
