package com.example.chocolatequest.client.render.entity;
...
import com.example.chocolatequest.client.model.entity.ModelLaser;
...
public class RenderLaser<T extends AbstractEntityLaser> extends EntityRenderer<T> {
	...
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(ChocolateQuestReDone.MODID, "textures/effects/ray.png");
	...
	public void renderModel(T entity, float yaw, float pitch, float partialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight, float laserLength) {
		VertexConsumer vertexBuilder = pBuffer.getBuffer(net.minecraft.client.renderer.RenderType.entityTranslucentEmissive(TEXTURE));
