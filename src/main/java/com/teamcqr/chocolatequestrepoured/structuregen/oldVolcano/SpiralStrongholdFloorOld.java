...
public class SpiralStrongholdFloorOld {
	...
	public SpiralStrongholdFloorOld(AbstractDungeonGenerator<DungeonVolcanoOld> generator, DungeonGenerator dungeonGenerator, Tuple<Integer, Integer> entrancePos, int entranceX, int entranceZ, boolean isLastFloor, int sideLength, int roomCount) {
	...
	public List<AbstractDungeonPart> buildRooms(DungeonVolcanoOld dungeon, int dunX, int dunZ, World world, String mobType) {
