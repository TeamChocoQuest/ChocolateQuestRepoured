...
import com.teamcqr.chocolatequestrepoured.network.client.handler.ArmorCooldownSyncPacketHandler;
...
import com.teamcqr.chocolatequestrepoured.network.client.handler.DungeonSyncPacketHandler;
import com.teamcqr.chocolatequestrepoured.network.client.handler.HookShotPlayerStopPacketHandler;
import com.teamcqr.chocolatequestrepoured.network.client.handler.ItemStackSyncPacketHandler;
...
import com.teamcqr.chocolatequestrepoured.network.server.handler.ExporterUpdatePacketHandler;
import com.teamcqr.chocolatequestrepoured.network.server.handler.ExtendedReachAttackPacketHandler;
...
import com.teamcqr.chocolatequestrepoured.network.server.handler.SaveStructureRequestPacketHandler;
import com.teamcqr.chocolatequestrepoured.network.server.handler.StructureSelectorPacketHandler;
import com.teamcqr.chocolatequestrepoured.network.server.handler.SyncEntityPacketHandler;
