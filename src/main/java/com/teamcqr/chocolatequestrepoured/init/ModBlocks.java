	...
	public static class BlockRegistrationHandler {
		...
		public static void registerBlocks(RegistryEvent.Register<Block> event) {
			final Block[] blocks = {
					...
					setBlockNameAndTab(new BlockExporterChest(LootTableList.CHESTS_VILLAGE_BLACKSMITH, Reference.MODID, "textures/blocks/exporter_chest_overlays/vanilla_blacksmith.png"), "exporter_chest_vanilla_blacksmith",
					...
					setBlockNameAndTab(new BlockExporterChest(LootTableList.CHESTS_END_CITY_TREASURE, Reference.MODID, "textures/blocks/exporter_chest_overlays/vanilla_end_city.png"), "exporter_chest_vanilla_end_city",
							CQRMain.CQR_EXPORTER_CHEST_TAB),
					...
					setBlockNameAndTab(new BlockExporterChest(LootTableList.CHESTS_JUNGLE_TEMPLE_DISPENSER, Reference.MODID, "textures/blocks/exporter_chest_overlays/vanilla_jungle_dispenser.png"), "exporter_chest_vanilla_jungle_dispenser",
							CQRMain.CQR_EXPORTER_CHEST_TAB),
					...
					setBlockNameAndTab(new BlockExporterChest(LootTableList.CHESTS_ABANDONED_MINESHAFT, Reference.MODID, "textures/blocks/exporter_chest_overlays/vanilla_mineshaft.png"), "exporter_chest_vanilla_mineshaft",
							CQRMain.CQR_EXPORTER_CHEST_TAB),
					...
					setBlockNameAndTab(new BlockExporterChest(LootTableList.CHESTS_STRONGHOLD_CORRIDOR, Reference.MODID, "textures/blocks/exporter_chest_overlays/vanilla_stronghold.png"), "exporter_chest_vanilla_stronghold",
							CQRMain.CQR_EXPORTER_CHEST_TAB),
					setBlockNameAndTab(new BlockExporterChest(LootTableList.CHESTS_STRONGHOLD_LIBRARY, Reference.MODID, "textures/blocks/exporter_chest_overlays/vanilla_stronghold_library.png"), "exporter_chest_vanilla_stronghold_library",
							CQRMain.CQR_EXPORTER_CHEST_TAB),
					setBlockNameAndTab(new BlockExporterChest(LootTableList.CHESTS_STRONGHOLD_CROSSING, Reference.MODID, "textures/blocks/exporter_chest_overlays/vanilla_stronghold_storeroom.png"), "exporter_chest_vanilla_stronghold_storeroom",
							CQRMain.CQR_EXPORTER_CHEST_TAB),
