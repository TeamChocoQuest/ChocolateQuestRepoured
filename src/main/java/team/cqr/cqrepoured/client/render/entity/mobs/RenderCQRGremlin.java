...
import team.cqr.cqrepoured.client.model.geo.entity.ModelCQRGremlinGeo;
...
public class RenderCQRGremlin extends RenderCQRBipedBaseGeo<EntityCQRGremlin> {
	...
	@Override
	protected void preRenderBlock(BlockState block, String boneName, EntityCQRGremlin currentEntity) {
	...
	@Override
	protected void postRenderBlock(BlockState block, String boneName, EntityCQRGremlin currentEntity) {
