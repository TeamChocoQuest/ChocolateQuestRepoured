...
public class DefaultSurfaceGenerator implements IDungeonGenerator {
	...
	public void preProcess(World world, Chunk chunk, int x, int y, int z) {
		...
		if (this.dungeon.doBuildSupportPlatform()) {
			...
			supportBuilder.createSupportHill(new Random(), world, new BlockPos(x, y + this.dungeon.getUnderGroundOffset(), z), this.structure.getSizeX(), this.structure.getSizeZ(), EPosType.DEFAULT);
		}
	}
