...
public class RenderCQRPirate extends RenderCQRBipedBaseGeo<EntityCQRPirate> {
	...
	@Override
	protected void preRenderItem(ItemStack item, String boneName, EntityCQRPirate currentEntity) {
	...
	@Override
	protected void postRenderItem(ItemStack item, String boneName, EntityCQRPirate currentEntity) {
	...
	@Override
	protected ResourceLocation getTextureForBone(String boneName, EntityCQRPirate currentEntity) {
		return null;
	}
