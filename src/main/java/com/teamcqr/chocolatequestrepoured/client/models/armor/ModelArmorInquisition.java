...
public class ModelArmorInquisition extends ModelCustomArmorBase {
	...
	public ModelArmorInquisition(float scale) {
		...
		this.gauntletL.addBox(-1.0F, 5.0F, -2.0F, 4, 4, 4, 0.0F);
		...
		this.pauldronL1.addBox(-1.0F, -3.0F, -2.5F, 5, 5, 5, 0.0F);
		...
		this.chest1.addBox(-4.5F, 0.0F, -2.5F, 9, 4, 4, 0.0F);
		...
		this.gauntletR.addBox(-3.0F, 5.0F, -2.0F, 4, 4, 4, 0.0F);
		this.pauldronRWing1 = new ModelRenderer(this, 64, 18);
		this.pauldronRWing1.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.pauldronRWing1.addBox(-4.5F, -5.0F, -3.5F, 5, 5, 2, 0.0F);
		...
		this.pauldronLWing2.addBox(-0.5F, -5.0F, 1.5F, 5, 5, 2, 0.0F);
		...
		this.pauldronRWing2.addBox(-4.5F, -5.0F, 1.5F, 5, 5, 2, 0.0F);
		...
		this.pauldronLWing1.addBox(-0.5F, -5.0F, -3.5F, 5, 5, 2, 0.0F);
		...
		this.pauldronR1.addBox(-4.0F, -3.0F, -2.5F, 5, 5, 5, 0.0F);
