...
public class ModelLich extends ModelCQRBiped {
    ...
    public ModelLich(float scale, float p_i1149_2_, int textureW, int textureH) {
    	super(scale, p_i1149_2_, textureW, textureH, false);
        ...
        this.Arm_Left_Bone.setRotationPoint(1.0F, 6.0F, 0.0F);
        ...
        this.Arm_Right_Bone.setRotationPoint(-1.0F, 6.0F, 0.0F);
