...
public class Channel {
	...
	/**
	 * Return the previous rotation KeyFrame before this frame that uses this box, if it exists. If currentFrame is a keyFrame that uses this box, it is returned.
	 */
	...
	/**
	 * Return the next rotation KeyFrame before this frame that uses this box, if it exists. If currentFrame is a keyFrame that uses this box, it is NOT considered.
	 */
	...
	/**
	 * Return the previous translation KeyFrame before this frame that uses this box, if it exists. If curretFrame is a keyFrame that uses this box, it is returned.
	 */
	...
	/**
	 * Return the next translation KeyFrame before this frame that uses this box, if it exists. If currentFrame is a keyFrame that uses this box, it is NOT considered.
	 */
