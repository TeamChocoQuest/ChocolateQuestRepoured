...
public class ItemStaffGun extends ItemBase
{
	public ItemStaffGun(String name) 
	{
		super(name);
		setMaxDamage(2048);
		setMaxStackSize(1);
...
/*	@Override
	...
	{
		worldIn.playSound(playerIn.posX,playerIn.posY, playerIn.posZ, SoundsHandler.GUN_SHOOT, SoundCategory.MASTER, 4.0F, (1.0F + (itemRand.nextFloat() - itemRand.nextFloat()) * 0.2F) * 0.7F, false);
