...
import team.cqr.cqrepoured.structuregen.generators.castleparts.rooms.decoration.DecorationSelector;
			...
			if (this.walls.containsKey(side) && this.walls.get(side).isEnabled()) {
				...
				for (BlockPos pos : edge) {
					...
					case 1:
						...
						break;
					/*
					 * case 2: if ((RoomDecorTypes.UNLIT_TORCH.wouldFit(pos, side, this.possibleDecoPositions, this.usedDecoPositions, this)) &&
