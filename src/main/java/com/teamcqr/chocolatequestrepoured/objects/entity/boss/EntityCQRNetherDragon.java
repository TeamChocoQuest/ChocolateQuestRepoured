...
public class EntityCQRNetherDragon extends /* AbstractEntityCQR */AbstractEntityCQRBoss implements IEntityMultiPart, IRangedAttackMob {
	 ...
	 * 
	 * If you see a player: Charge at it, bite it, fly in a 22.5° angle upwards until you flew 5 blocks up Then begin spiraling up to your "strafing y", there you fly 0.5 - 3 rounds on your circle and attack again While you are circling,
	 * you may change to a higher, thinner circler, about 10 blocks above the normal. You fly up to it by spiraling up or down, whilst charging at the player you may spit fire or shoot fireballs
	 */
	 ...
	 * 
	 * Also the nether dragon destroys all blocks in its hitbox, if these are not lava, also if the block it moved through are leaves or burnable, it will set them on fire It will also break obsidian blocks, but not command blocks or
	 * structure blocks or bedrock
	 */

	public EntityCQRNetherDragon(World worldIn) {
		super(worldIn, 32);
		/*
		 * this.dragonBodyParts = new MultiPartEntityPart[] { this.headPart, this.body1, this.body2, this.body3, this.body4, this.body5, this.body6, this.body7, this.body8, this.body9, this.body10, this.body11, this.body12, this.body13,
		 * this.body14, this.body15, this.body16 };
		 */
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		/*
		 * if (source instanceof EntityDamageSource && ((EntityDamageSource) source).getIsThornsDamage()) { //return this.attackEntityFromPart(this.headPart, source, amount); return true; }
		 */
	...
	public void onLivingUpdate() {
		...
		/*
		 * for(EntityCQRNetherDragonSegment part : this.dragonBodyParts) { destroyBlocksInAABB(part.getEntityBoundingBox()); }
		 */
