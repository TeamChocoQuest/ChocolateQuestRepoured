 ...
 */
public class GeneratorVolcanoOld extends AbstractDungeonGenerator<DungeonVolcanoOld> {
	...
	public GeneratorVolcanoOld(World world, BlockPos pos) {
		super(world, pos, new DungeonVolcanoOld());
	...
	public void buildStructure() {
		...
		if (this.dungeon.doBuildDungeon()) {
			final StrongholdBuilderOld entranceBuilder = new StrongholdBuilderOld(this, this.dungeonGenerator, this.entranceStartPos, this.entranceDistToWall, this.dungeon, this.entranceDirection.getAsSkyDirection(), world);
