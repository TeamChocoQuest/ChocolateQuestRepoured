...
public final class ECPhaseIdle implements IEnderCalamityPhase {
	...
	public IEnderCalamityPhase[] getPossibleSuccessors() {
		return new IEnderCalamityPhase[] {
				EEnderCalamityPhase.PHASE_LASERING.getPhaseObject(),
				EEnderCalamityPhase.PHASE_BUILDING.getPhaseObject(),
				EEnderCalamityPhase.PHASE_TELEPORT_EYE_THROWER.getPhaseObject(),
				EEnderCalamityPhase.PHASE_TELEPORT_LASER.getPhaseObject() };
	}
