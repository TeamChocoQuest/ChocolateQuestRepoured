...
public final class Matrix3f implements Cloneable, java.io.Serializable {
	...
	/**
	 * <code>get</code> retrieves a value from the matrix at the given position. If the position is invalid an exception is thrown.
	 * 
	...
	/**
	 * <code>set</code> places a given value into the matrix at the given position. If the position is invalid an exception is thrown.
	 * 
	 * @param i     the row index.
	 * @param j     the colum index.
