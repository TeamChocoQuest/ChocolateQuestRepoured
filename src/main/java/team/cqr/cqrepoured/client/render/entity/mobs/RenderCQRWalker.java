...
public class RenderCQRWalker extends RenderCQRBipedBaseGeo<EntityCQRWalker> {
	...
	@Override
	protected void preRenderItem(ItemStack item, String boneName, EntityCQRWalker currentEntity) {
	...
	@Override
	protected void postRenderItem(ItemStack item, String boneName, EntityCQRWalker currentEntity) {
	...
	@Override
	protected ResourceLocation getTextureForBone(String boneName, EntityCQRWalker currentEntity) {
		return null;
	}
