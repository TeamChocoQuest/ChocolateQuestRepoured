...
public enum EBanners {
	...
	// BannerPattern.GRADIENT, BannerPattern.BORDER}, new EnumDyeColor[] {EnumDyeColor.BLUE,
	...
	// BannerPattern.CIRCLE_MIDDLE, BannerPattern.STRAIGHT_CROSS}, new EnumDyeColor[]
	...
	GREMLIN_BANNER(EnumDyeColor.GRAY, new BannerPattern[] { EBannerPatternsCQ.CQ_BLANK.getPattern(), BannerPattern.STRIPE_SMALL, BannerPattern.STRIPE_CENTER, BannerPattern.DIAGONAL_RIGHT_MIRROR, BannerPattern.FLOWER, BannerPattern.GRADIENT_UP, BannerPattern.GRADIENT },
			new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.RED, EnumDyeColor.GRAY, EnumDyeColor.GRAY, EnumDyeColor.WHITE, EnumDyeColor.RED, EnumDyeColor.BLACK }, "Gremlins"),;
