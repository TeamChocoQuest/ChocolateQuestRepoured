...
public class ModelCQRWasp extends ModelBase {
    ...
    public ModelCQRWasp() {
        ...
        this.wingR.addBox(0.0F, 0.0F, -2.0F, 8, 0, 4, 0.0F);
        ...
        this.wingL.addBox(0.0F, 0.0F, -2.0F, 8, 0, 4, 0.0F);
        ...
        this.sting.addBox(-1.0F, -1.0F, -1.0F, 2, 2, 4, 0.0F);
        ...
        this.bodyMain.addBox(-2.0F, -2.0F, -3.0F, 4, 4, 6, 0.0F);
        this.bodyBack = new ModelRenderer(this, 29, 9);
        this.bodyBack.setRotationPoint(0.0F, 0.0F, 2.4F);
        this.bodyBack.addBox(-1.5F, -1.5F, 0.0F, 3, 3, 4, 0.0F);
