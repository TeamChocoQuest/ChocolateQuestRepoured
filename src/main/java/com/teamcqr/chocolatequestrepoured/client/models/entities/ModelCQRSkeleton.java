...
//Copied from vanilla skeleton mode, but modified
     ...
     */
    public void setLivingAnimations(AbstractEntityCQR entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime)
    {
