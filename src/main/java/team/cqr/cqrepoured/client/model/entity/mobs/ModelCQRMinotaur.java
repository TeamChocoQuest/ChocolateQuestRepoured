...
public class ModelCQRMinotaur extends ModelCQRBiped<EntityCQRMinotaur> {
	...
	public ModelCQRMinotaur() {
		...
		this.tail2.setPos(-0.5F, 4.2F, -0.5F);
		...
		this.tail1.setPos(-0.5F, 10.5F, 1.3F);
		...
		this.hornL2.setPos(7.0F, -9.0F, -3.0F);
		...
		this.hornL1.setPos(6.0F, -8.0F, -3.0F);
		...
		this.hornR1.setPos(-6.8F, -6.0F, -3.0F);
