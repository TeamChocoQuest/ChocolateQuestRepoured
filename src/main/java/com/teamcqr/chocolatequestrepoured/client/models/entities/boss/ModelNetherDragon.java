...
/**
 * Nether Dragon - ArloTheEpic Created using Tabula 7.0.0
 */
public class ModelNetherDragon extends ModelBase {
	...
	public ModelNetherDragon() {
		...
		this.setRotateAngle(this.hornLeftC, 0.0F, 0.0F, 0.7740535232594852F);
		...
		this.setRotateAngle(this.hornLeftB, 0.0F, 0.0F, 0.8196066167365371F);
		...
		this.setRotateAngle(this.hornLeftA, -0.5009094953223726F, 0.3518583772020568F, -0.13439035240356337F);
		...
		this.setRotateAngle(this.hornRightB, 0.0F, 0.0F, 0.8196066167365371F);
		...
		this.setRotateAngle(this.hornRightC, 0.0F, 0.0F, 0.7740535232594852F);
		...
		this.setRotateAngle(this.hornRightA, 0.5009094953223726F, -0.3518583772020568F, -0.13439035240356337F);
