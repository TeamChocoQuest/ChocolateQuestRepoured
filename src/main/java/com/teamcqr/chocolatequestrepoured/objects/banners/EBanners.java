...
public enum EBanners {
	...
	PIRATE_BANNER(EnumDyeColor.BLACK, new BannerPattern[] { EBannerPatternsCQ.CQ_BLANK.getPattern(), BannerPattern.SKULL }, new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.WHITE }, "Flag Of Piracy"), WALKER_BANNER(EnumDyeColor.SILVER,
			...
			new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.GRAY, EnumDyeColor.CYAN, EnumDyeColor.BLACK, EnumDyeColor.BLACK }, "Nightwatch"), PIGMAN_BANNER(EnumDyeColor.RED, new BannerPattern[] {
					EBannerPatternsCQ.CQ_BLANK.getPattern(),
					EBannerPatternsCQ.FIRE.getPattern() }, new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.YELLOW }, "Pigman"), ENDERMEN_BANNER(EnumDyeColor.MAGENTA, new BannerPattern[] {
							EBannerPatternsCQ.CQ_BLANK.getPattern(),
							BannerPattern.TRIANGLE_BOTTOM,
							BannerPattern.TRIANGLE_TOP }, new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.BLACK, EnumDyeColor.BLACK }, "Enderman"), ENDERMEN_BANNER2(EnumDyeColor.MAGENTA, new BannerPattern[] {
									EBannerPatternsCQ.CQ_BLANK.getPattern(),
									BannerPattern.SQUARE_TOP_RIGHT,
									BannerPattern.SQUARE_BOTTOM_LEFT }, new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.BLACK, EnumDyeColor.BLACK }, "Enderman"), NPC_BANNER(EnumDyeColor.RED, new BannerPattern[] {
											EBannerPatternsCQ.CQ_BLANK.getPattern(),
											BannerPattern.FLOWER,
											BannerPattern.STRIPE_CENTER,
											EBannerPatternsCQ.EMERALD.getPattern() }, new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.YELLOW, EnumDyeColor.RED, EnumDyeColor.LIME }, "Merchants"), SKELETON_BANNER(EnumDyeColor.BLACK,
													new BannerPattern[] { EBannerPatternsCQ.CQ_BLANK.getPattern(), BannerPattern.CROSS, EBannerPatternsCQ.BONES.getPattern() }, new EnumDyeColor[] {
															EnumDyeColor.WHITE,
															EnumDyeColor.RED,
															EnumDyeColor.WHITE }, "Undead Bones"),
	...
	ILLAGER_BANNER(EnumDyeColor.WHITE, new BannerPattern[] {
			...
			BannerPattern.HALF_HORIZONTAL }, new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.RED, EnumDyeColor.SILVER, EnumDyeColor.GRAY, EnumDyeColor.SILVER, EnumDyeColor.BLACK, EnumDyeColor.SILVER }, "Pillagers"),

	WALKER_ORDO(EnumDyeColor.WHITE, new BannerPattern[] {
			EBannerPatternsCQ.CQ_BLANK.getPattern(),
			...
			EBannerPatternsCQ.WALKER_SKULL.getPattern() }, new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.PURPLE, EnumDyeColor.PURPLE, EnumDyeColor.BLACK, EnumDyeColor.GRAY, EnumDyeColor.BLACK, }, "Abyss Walker Flag"),

	GREMLIN_BANNER(EnumDyeColor.GRAY, new BannerPattern[] {
			EBannerPatternsCQ.CQ_BLANK.getPattern(),
			...
			BannerPattern.GRADIENT }, new EnumDyeColor[] { EnumDyeColor.WHITE, EnumDyeColor.RED, EnumDyeColor.GRAY, EnumDyeColor.GRAY, EnumDyeColor.WHITE, EnumDyeColor.RED, EnumDyeColor.BLACK }, "Gremlins"),;
