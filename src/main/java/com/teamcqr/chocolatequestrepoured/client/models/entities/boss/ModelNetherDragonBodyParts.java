...
public class ModelNetherDragonBodyParts {
	...
	public static class ModelNetherDragonBodyPartSkeletal extends ModelBase {
	    ...
	    public ModelNetherDragonBodyPartSkeletal() {
	        this.textureWidth = 128;
	        this.textureHeight = 64;
	        this.ribRLowerBack = new ModelRenderer(this, 0, 0);
	        ...
	        this.ribLUpper = new ModelRenderer(this, 0, 0);
	        ...
	        this.ribLMiddleBack = new ModelRenderer(this, 0, 0);
	        ...
	        this.RibRUpperBack = new ModelRenderer(this, 0, 0);
	        ...
	        this.ribRMiddle = new ModelRenderer(this, 0, 0);
	        ...
	        this.ribLLower_1 = new ModelRenderer(this, 0, 0);
	        ...
	        this.RibRUpper = new ModelRenderer(this, 0, 0);
	        ...
	        this.ribRLower = new ModelRenderer(this, 0, 0);
	        ...
	        this.ribLUpperBack = new ModelRenderer(this, 0, 0);
	        ...
	        this.ribLMiddle = new ModelRenderer(this, 0, 0);
