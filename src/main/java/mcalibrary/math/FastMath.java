...
public class FastMath {
	...
	/**
	 * Returns the arc cosine of an angle given in radians. Special cases: If fValue is smaller than -1, then the result is PI. If the argument is greater than 1, then the result is 0.
	 */
